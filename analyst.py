...
สำคัญ: ประเมินด้วยว่า "ข่าวนี้คุ้มที่จะเตือนเทรดเดอร์ทองหรือไม่" (should_alert)
- should_alert = true  เมื่อ เป็นข้อมูลใหม่ + เซอร์ไพรส์/ต่างจากที่ตลาดคาด + มีโอกาสทำให้ราคาทองขยับจริง
  (เช่น ตัวเลขออกต่างจาก forecast ชัด, Fed เปลี่ยนท่าทีกะทันหัน, เกิดสงคราม/เหตุฉุกเฉิน)
- should_alert = false เมื่อ ข่าวถูก price-in แล้ว / ออกตรงตามคาด / เป็นข่าวเก่า-ซ้ำ /
  เป็นบทความความเห็นทั่วไป / ไม่กระทบทองจริง (ราคาทองน่าจะนิ่ง) -> ไม่ต้องรบกวนผู้ใช้
